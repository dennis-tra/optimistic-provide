...
func (s *SendRequestStart) Details() string {
	return s.Request.Type.String()
}
...
func (s *SendRequestEnd) Error() error {
	return s.Err
}

func (s *SendRequestEnd) Details() string {
	if s.Err == nil {
		return s.Response.Type.String()
	}
	return ""
}
...
func (s *SendMessageStart) Details() string {
	return s.Message.Type.String()
}
...
func (s *SendMessageEnd) Error() error {
	return s.Err
}

func (s *SendMessageEnd) Details() string {
	if s.Err == nil {
		return s.Message.Type.String()
	}
	return ""
