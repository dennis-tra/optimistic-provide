...
func (ipAddressL) LoadMultiAddresses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeIPAddress interface{}, mods queries.Applicator) error {
	var slice []*IPAddress
	...
	if singular {
		...
		slice = *maybeIPAddress.(*[]*IPAddress)
	}
...
func IPAddresses(mods ...qm.QueryMod) ipAddressQuery {
	...
	return ipAddressQuery{NewQuery(mods...)}
}
