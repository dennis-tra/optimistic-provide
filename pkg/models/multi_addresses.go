...
func (o *MultiAddress) Connections(mods ...qm.QueryMod) connectionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"connections\".\"multi_address_id\"=?", o.ID),
	)
...
func (multiAddressL) LoadConnections(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMultiAddress interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`connections`),
		qm.WhereIn(`connections.multi_address_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
