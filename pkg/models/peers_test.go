...
func testPeerToManyHosts(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := PeerSlice{&a}
	if err = a.L.LoadHosts(ctx, tx, false, (*[]*Peer)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testPeerToManyNetworkSizeEstimates(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := PeerSlice{&a}
	if err = a.L.LoadNetworkSizeEstimates(ctx, tx, false, (*[]*Peer)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testPeerToManyAddOpHosts(t *testing.T) {
	var err error
...
func testPeerToManyAddOpNetworkSizeEstimates(t *testing.T) {
	var err error
